...
#include <shaders/gltf/inputs.frag>
#include <shaders/gltf/PBR.sp>
...
pbrInputs.transmissionFactor = 0.0;
pbrInputs.thickness = 0.0;
pbrInputs.attenuation = vec4(1.0, 1.0, 1.0, 0.0);
  if (isTransmission) {
...
//out_FragColor = Kao;
 //out_FragColor = Ke;
// out_FragColor = Kd; 
//out_FragColor = sampleAlbedo(tc,mat); 
